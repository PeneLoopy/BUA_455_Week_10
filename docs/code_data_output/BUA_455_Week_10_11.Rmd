...
- **Final Proposals are due on Tuesday, 11/14** 

  - There is a 24 hours grace period for final proposals.

- Project presentations will take place on Tuesday 12/12.

- HW 5 - Part 1 is due Friday, 11/3, at midnight (Grace period ends Monday, 11/6 at midnight).

- HW 5 - Part 2 will be posted after Quiz 2) and due on Wednesday 12/6.
...
- Tue. 11/7: Skills/Concepts Review for Quiz 2
...
grid.arrange(cnty_hs_grad, cnty_computer, cnty_bachelors, cnty_brdbd, ncol=2)
ggsave("Wk2_Example_Plot_Grid_Penelope_Pooler.png", height=4, width=6)
...
### **Key Points from Week 10 and 11**
...
- Quiz 2 will be on Thursday, 11/9.
