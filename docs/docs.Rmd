...
subtitle: "Introduction To Geographic Data" 
...
- **If you want help with project data, please reach out to meor TAs**.
...
png("filename_in_quotes.png", height=480, width=720)
plotname
dev.off()
...
**Map of untranformed households per county data is uninformative.**
...
```{r log transformed hh data map, echo=F, fig.align='center', fig.dim=c(14,8)}
